			...
			messages: [
				{
					...
					content:
						...
						createSatcatTable +
						owner_lookup_table +
						'Remember, we are looking only for NORAD_CAT_IDs. For height/altitude queries, use APOGEE before PERIGEE. Countries may have multiple aliases, eg for China you would have to include: WHERE COUNTRY IN ("PRC", "CHLE", "CHTU", "CHBZ")'
				},
